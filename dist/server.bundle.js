...
/***/ function(module, exports, __webpack_require__) {
	...
	var _apiCaller = __webpack_require__(46);
...
/***/ function(module, exports) {
	...
	var ADJECTIVES = ['Abrasive', 'Brash', 'Callous', 'Daft', 'Eccentric', 'Fiesty', 'Golden', 'Holy', 'Ignominious', 'Joltin', 'Killer', 'Luscious', 'Mushy', 'Nasty', 'OldSchool', 'Pompous', 'Quiet', 'Rowdy', 'Sneaky', 'Tawdry', 'Unique', 'Vivacious', 'Wicked', 'Xenophobic', 'Yawning', 'Zesty'];

	var FIRST_NAMES = ['Anna', 'Bobby', 'Cameron', 'Danny', 'Emmett', 'Frida', 'Gracie', 'Hannah', 'Isaac', 'Jenova', 'Kendra', 'Lando', 'Mufasa', 'Nate', 'Owen', 'Penny', 'Quincy', 'Roddy', 'Samantha', 'Tammy', 'Ulysses', 'Victoria', 'Wendy', 'Xander', 'Yolanda', 'Zelda'];

	var LAST_NAMES = ['Anchorage', 'Berlin', 'Cucamonga', 'Davenport', 'Essex', 'Fresno', 'Gunsight', 'Hanover', 'Indianapolis', 'Jamestown', 'Kane', 'Liberty', 'Minneapolis', 'Nevis', 'Oakland', 'Portland', 'Quantico', 'Raleigh', 'SaintPaul', 'Tulsa', 'Utica', 'Vail', 'Warsaw', 'XiaoJin', 'Yale', 'Zimmerman'];

	function randomUsername() {
	    var rando = function rando(arr) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PostCreateWidget = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _randos = __webpack_require__(9);

	var router = new _express.Router();

	var AccessToken = __webpack_require__(68).AccessToken;
	var VideoGrant = AccessToken.VideoGrant;

	router.route('/token').get(function (request, response) {
	    var identity = (0, _randos.randomUsername)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _twilioVideo = __webpack_require__(47);
	...
	}, void 0, 'Hello Beautiful'), _jsx('div', {
	  id: 'local-media'
	}), _jsx('button', {
	  id: 'button-preview'
	}, void 0, 'Preview My Camera')), _jsx('div', {
	  id: 'room-controls'
	}, void 0, _jsx('p', {
	  className: 'instructions'
	}, void 0, 'Room Name:'), _jsx('input', {
	  id: 'room-name',
	  type: 'text',
	  placeholder: 'Enter a room name'
	}), _jsx('button', {
	  id: 'button-join'
	}, void 0, 'Join Room'), _jsx('button', {
	  id: 'button-leave'
	}, void 0, 'Leave Room')), _jsx('div', {
	  id: 'log'
	}));
...
/***/ function(module, exports) {
	...
	exports.twilioStart = twilioStart;
	function twilioStart() {
	  ...
	  getJSON('token/token', function (data) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _cuid = __webpack_require__(51);
